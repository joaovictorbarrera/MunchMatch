    ...
    return (
        <div className="flex flex-col gap-2">
            <form onSubmit={e => e.preventDefault()} className="flex flex-col gap-10 items-center" action="">
                ...
                <input className=" bg-mm-primary rounded-sm  border-b-[1px] border-mm-text p-2" min={500} defaultValue={questionnaire.calories == -1 ? undefined : questionnaire.calories} onChange={handleCalorieChange} type="number" />
            </form>
        </div>
    )
